...
public class FlashSaleController {
    ...
    private Map<String, Object> toFlashSaleDTO(FlashSale flashSale) {
        ...
        // Format dates as ISO strings for JavaScript
        if (flashSale.getStartTime() != null) {
            dto.put("startTime", flashSale.getStartTime().toString());
        }
        if (flashSale.getEndTime() != null) {
            dto.put("endTime", flashSale.getEndTime().toString());
        }
    ...
    private Map<String, Object> toFlashSaleProductDTO(FlashSaleProduct fsp) {
        ...
        String productImage = fsp.getProduct().getProductImage();
        if (productImage != null && !productImage.isEmpty()) {
            dto.put("productImage", "/loadImage?imageName=" + productImage);
        } else {
            dto.put("productImage", "/assets/img/examples/product1.jpg");
        }
